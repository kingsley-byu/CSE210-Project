...
class Program
{
    static void Main(string[] args)
    {
        ...
        Comment comment8 = new Comment("Keneth", "Nice fight");
        ...
        Comment comment11= new Comment("kingsley osas", "Ilove the temple");
        ...
        Comment comment13 = new Comment("kingston", "God bless our Prophect");
